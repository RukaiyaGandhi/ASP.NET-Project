<%@ WebHandler Language="C#" Class="HouseImageHandler" %>
using System;
using System.Web;
...
public class HouseImageHandler : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //using (SqlConnection connection = new SqlConnection("Data Source=DESKTOP-PG9HKCK;Initial Catalog=Society_MANAGEMENT;Integrated Security=True"))
        {
            ...
            using (SqlCommand command = new SqlCommand("SELECT HImage FROM House_Details WHERE House_ID = @Id", connection))
            {
